  ...
  return (
    <div>
      ...
      <div className="bg-white shadow rounded-lg p-5 mb-4">
        <h2 className="card-title mb-3">Awaiting my approval ({pending.length})</h2>
        {pending.length === 0 ? (
      ...
      {/* Everything else I'm in the chain of — including requests rejected below me */}
      <div className="bg-white shadow rounded-lg p-5">
        <h2 className="card-title mb-3">In my approval chain ({others.length})</h2>
        {others.length === 0 ? (
