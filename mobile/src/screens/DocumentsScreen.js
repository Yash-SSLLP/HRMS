...
import { Screen, Card, Pill, Loader, refresher, SectionHeader, EmptyState, Ionicons } from '../components/ui';
...
export default function DocumentsScreen() {
  ...
  if (loading) return <Screen><Loader text="Loading documents" /></Screen>;
